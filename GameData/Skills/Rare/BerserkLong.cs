...
public class BerserkLong : Skill
{
    ...
    public override string Description => "Long vars gain fixed damage and lose fixed defense while exactly one enemy is in detect range.";
    ...
    public override ISkillRuntime GetSkillRuntime() => new BerserkLongRuntime(Resource);
}
