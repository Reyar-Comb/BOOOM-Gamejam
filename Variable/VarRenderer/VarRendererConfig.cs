...
public partial class VarRendererConfig : Resource
{
	...
	[Export] public Color UnexploredRegionColor { get; set; } = Colors.Black;
	...
	[Export] public Godot.Collections.Dictionary<VarStats.VarType, Texture2D> VarTypeTextures { get; set; } = new();
	[Export] public Vector2 VarPieceGridSize { get; set; } = new(100f, 100f);
	[Export(PropertyHint.Range, "10,500,1")] public float VarPieceTextureSize { get; set; } = 80f;
	[Export] public float VarPieceCornerRadius { get; set; } = 8.0f;
	[Export(PropertyHint.Range, "0.02,1,0.01")] public float VarPieceAnimationDuration { get; set; } = 0.15f;
	[Export] public Color VarPieceBorderColor { get; set; } = Colors.White;
